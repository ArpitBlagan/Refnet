...
const items = [
  {
    text: 'Refnet',
    icon: (
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="h-[25px] w-[30px]">
        <path
          fill="#F2F4F8"
...
function Sidebar() {
  ...
  return (
    <div
      className=" md:w-[235px] border-r border-zinc-800 w-[50px] 
    flex flex-col gap-7 items-center h-full px-10 py-10"
    >
      {items.map((ele, index) => {
        return (
          <Link
