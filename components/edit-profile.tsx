          ...
          <DialogDescription>
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2">
                <label className="font-semibold text-white">New profile image</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="font-semibold text-white">About you and your background</label>
                <Textarea
                  value={description}
                  onChange={(e) => {
                ...
                />
                <p className="text-sm text-muted-foreground">Write it within 300 words</p>
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3 justify-end pt-4 border-t border-zinc-800">
                <Button className="font-bold hover:bg-white hover:text-black">Cancle</Button>
                <Button
                  type="submit"
                  disabled={loading}
